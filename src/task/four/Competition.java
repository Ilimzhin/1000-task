...
// в файл input.txt записываем в первой строке количество задач например (3),
// во второй строке записываем количество минут на каждую задачу например ( 40 50 30)


public class Competition {

    private static ArrayList<String> list = new ArrayList<>(); // коллекция для построчного считывание данных
    private static ArrayList<Integer> time = new ArrayList<>(); // коллекция для времени на решение задач
